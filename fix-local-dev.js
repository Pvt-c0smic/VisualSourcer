...
console.log('Remember to run "node restore-config.js" before pushing to Replit.');

// Create a restore script if it doesn't exist
const restoreFilePath = path.join(__dirname, 'restore-config.js');
...
`;
  ...
  console.log('Created restore-config.js script to revert changes when needed.');
}